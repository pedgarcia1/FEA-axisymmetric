function [stress]=stress(elementType,elementNodesArray,nodesPositionArray,constitutiveMatrix,displacementsVector)
...
for iElement = 1:nElements
    ...
    for iGaussPoint = 1:nGaussPoints
        ...
        structuralShapeFunctionsDerivatives = inv(jacobian)*shapeFunctionsDerivatives(:,:,iGaussPoint);
...
%     stiffnessMatrix(elementalDofs,elementalDofs) = stiffnessMatrix(elementalDofs,elementalDofs) + elementalStiffnessMatrix;
    stress(elementalDofs) = constitutiveMatrix*B*displacementsVector(elementalDofs);
end
