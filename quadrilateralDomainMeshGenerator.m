function [elementNodesArray,nodesPositionArray,vertexNodes,sideNodes]=quadrilateralDomainMeshGenerator(elementType,quadrilateralShape,meshLength,meshHeight,nElementsInLength,nElementsInHeight,meshAngle,distortion)
...
switch quadrilateralShape
    ...
    case 'Curved'; % Nodal Discretization Circular Mesh
        ...
        [radialPosition,angularPosition]=meshgrid(meshInnerRadious+(0:meshHeight/(nNodesInHeight-1):meshHeight),0:meshAngle/(nNodesInLength-1):meshAngle);
        %Mesh distortion
