...
switch problemType
    ...
    case 'Axisymmetric 2'
        constitutiveMatrix = youngModulus / (1 + poissonRatio) /(1 - 2*poissonRatio) * [1.0-poissonRatio    poissonRatio         0                   0.0
                                                                                        poissonRatio        1.0-poissonRatio     0                   0.0
                                                                                        0                   0                    1.0-poissonRatio    0.0
                                                                                        0.0                 0.0                  0.0                 0.5 - poissonRatio];
