...
%% Mesh generation
 [meshInfo.elements,meshInfo.nodes,meshInfo.vertexNodes,meshInfo.sideNodes]=quadrilateralDomainMeshGenerator(eleType,'Straight',400,AlturaY,40,nElemEnY,0,0);
%  
