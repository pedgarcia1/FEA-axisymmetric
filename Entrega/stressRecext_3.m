function [stressExtra,elementStressAtGaussPoints]=stressRecext_3(elementType,elementNodesArray,nodesPositionArray,constitutiveMatrix,nodalDisplacements)
...
for iele = 1:nElements
    for inode = 1:nPoints
        ...
        stressExtra(iele,inode,:) = N * squeeze(elementStressAtGaussPoints(iele,:,:));
    end
end
end
