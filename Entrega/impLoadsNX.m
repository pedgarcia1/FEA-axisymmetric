function finalLoads = impLoadsNX(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   FINALLOADS = IMPORTFILE(FILENAME)
%   Reads data from text file FILENAME for the default selection.
%
%   FINALLOADS = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   finalLoads = importfile('finalLoads.csv', 2, 62874);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2023/12/01 11:55:16
...
finalLoads = table(dataArray{1:end-1}, 'VariableNames', {'NodeID','RCoord','TCoord','ZCoord','R','T','Z','Magnitude'});
