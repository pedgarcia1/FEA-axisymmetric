function bandploterror(elementos,nodos,variable,lims,lineColor,nColores)
...
for iele = 1:nel
    ...
    h = patch('Faces',vNod,'Vertices',nodos(eleNodes,:),'FaceVertexCData', ...
        variable(iele,1:nNodos)');
